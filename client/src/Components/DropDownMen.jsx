          ...
          <div className={style.mainmain} onMouseEnter={() => this.props.changeView('men')} onMouseLeave={() => this.props.changeView('')} >
           ...
           <div className={style.maindropdown}  >
              <ul className={style.ulDropDown}>
                ...
                <li className={style.liDropDown}><a href="#" >Golf Collection</a></li>
                <li className={style.seperator}>&nbsb;</li>
              ...
              <ul className={style.ulDropDown}>
                ...
                <li className={style.liDropDown}><a href="#" >Football</a></li>
              ...
              CLOTHING
                ...
                <li className={style.liDropDown}><a href="#" >T-shirts</a></li>
                <li className={style.liDropDown}><a href="#" >Long Sleeve Shirts</a></li>
                <li className={style.liDropDown}><a href="#" >Jerseys</a></li>
                <li className={style.liDropDown}><a href="#" >Tights</a></li>
                ...
                <li className={style.liDropDown}><a href="#" >Underwear</a></li>
                <li className={style.liDropDown}><a href="#" >Phone Cases</a></li>
                <li className={style.liDropDown}><a href="#" >Sunglassesv</a></li>
